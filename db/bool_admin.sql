/*
 ...
 Source Server         : bool_admin_server
...
INSERT INTO `qu_example_demo` (`id`, `week`, `flag`, `genderdata`, `actdata`, `title`, `content`, `keywords`, `description`, `image`, `images`, `attachfile`, `city`, `price`, `startdate`, `create_time`, `update_time`, `weigh`, `switch`, `status`, `category_id`, `name`) VALUES (14, 4, '3', 1, '1,2', '完整表单案例4', '<p>完整表单案例4</p>', '完整表单案例4', '完整表单案例4', 'http://yyc-1301620739.cos.ap-nanjing.myqcloud.com/20220429626b9d851d9c4.png', '', '', '江苏省,无锡市,锡山区', 0.00, 1643212800, NULL, '2022-05-02 14:41:52', 0, 0, 1, 4, '111');
...
-- ----------------------------
BEGIN;
INSERT INTO `qu_system_admin` (`id`, `username`, `phone`, `password`, `head_image`, `email`, `status`, `create_time`, `update_time`, `group_ids`, `nickname`, `admin_id`) VALUES (1, 'admin', '', 'e10adc3949ba59abbe56e057f20f883e', 'http://yyc-1301620739.cos.ap-nanjing.myqcloud.com/202205056273755e06da7.png', '', 1, NULL, '2022-05-05 14:58:45', '1,4', 'admin', 0);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `qu_system_config` (`id`, `name`, `title`, `group`, `sign`, `type`, `value`, `remark`, `weigh`, `create_time`, `update_time`) VALUES (1, 'site_logo', '网站logo', 'site', '', 'image', 'site', '网站的logo', 0, NULL, NULL);
INSERT INTO `qu_system_config` (`id`, `name`, `title`, `group`, `sign`, `type`, `value`, `remark`, `weigh`, `create_time`, `update_time`) VALUES (2, 'site_title', '网站标题', 'site', '', 'input', 'site', '网站的logo', 0, NULL, NULL);
INSERT INTO `qu_system_config` (`id`, `name`, `title`, `group`, `sign`, `type`, `value`, `remark`, `weigh`, `create_time`, `update_time`) VALUES (3, 'site_copyright', '版权信息', 'site', '', 'input', 'site', '网站的版权', 0, NULL, NULL);
INSERT INTO `qu_system_config` (`id`, `name`, `title`, `group`, `sign`, `type`, `value`, `remark`, `weigh`, `create_time`, `update_time`) VALUES (4, 'site_beian', '备案信息', 'site', '', 'input', 'site', '网站备案信息', 0, NULL, NULL);
INSERT INTO `qu_system_config` (`id`, `name`, `title`, `group`, `sign`, `type`, `value`, `remark`, `weigh`, `create_time`, `update_time`) VALUES (5, 'upload_ext', '允许后缀', 'upload', '', '', 'upload', '上传允许的后缀', 0, NULL, NULL);
INSERT INTO `qu_system_config` (`id`, `name`, `title`, `group`, `sign`, `type`, `value`, `remark`, `weigh`, `create_time`, `update_time`) VALUES (6, 'upload_url', '图片路径', 'upload', '', '', 'upload', '上传文件访问地址', 0, NULL, NULL);
INSERT INTO `qu_system_config` (`id`, `name`, `title`, `group`, `sign`, `type`, `value`, `remark`, `weigh`, `create_time`, `update_time`) VALUES (7, 'site_switch', '网站开关', 'site', '', '', 'site', '网站是否关闭', 0, NULL, NULL);
INSERT INTO `qu_system_config` (`id`, `name`, `title`, `group`, `sign`, `type`, `value`, `remark`, `weigh`, `create_time`, `update_time`) VALUES (8, 'site_ip_blacklist', 'ip黑名单', 'site', '', '', 'site', 'ip黑名单用逗号隔开', 0, NULL, NULL);
INSERT INTO `qu_system_config` (`id`, `name`, `title`, `group`, `sign`, `type`, `value`, `remark`, `weigh`, `create_time`, `update_time`) VALUES (9, 'site_open_time', '网站维护时间', 'site', '', '', 'site', '网站维护时间', 0, NULL, NULL);
INSERT INTO `qu_system_config` (`id`, `name`, `title`, `group`, `sign`, `type`, `value`, `remark`, `weigh`, `create_time`, `update_time`) VALUES (10, 'site_isreg', '允许注册', 'site', '', '', 'site', '是否允许注册', 0, NULL, NULL);
INSERT INTO `qu_system_config` (`id`, `name`, `title`, `group`, `sign`, `type`, `value`, `remark`, `weigh`, `create_time`, `update_time`) VALUES (11, 'upload_type', '上传方式', 'upload', '', '', 'upload', '上传方式', 0, NULL, NULL);
INSERT INTO `qu_system_config` (`id`, `name`, `title`, `group`, `sign`, `type`, `value`, `remark`, `weigh`, `create_time`, `update_time`) VALUES (12, 'site_back_image', '登录页背景图', 'site', '', 'image', 'site', '登录页背景', 0, NULL, NULL);
INSERT INTO `qu_system_config` (`id`, `name`, `title`, `group`, `sign`, `type`, `value`, `remark`, `weigh`, `create_time`, `update_time`) VALUES (13, 'site_icon', 'icon', 'site', '', 'image', 'site', '网站小icon', 0, NULL, NULL);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `qu_system_files` (`id`, `upload_type`, `original_name`, `url`, `image_width`, `image_height`, `image_frames`, `mime_type`, `file_size`, `file_ext`, `sha1`, `create_time`, `update_time`, `file_type`) VALUES (1, 'local', 'logo.png', 'http://qa-prod.demo.com/storage/system/20221009/d519b7d8db50c426d1d7ca598eed0149.png', '', '', 0, 'image/png', 34091, 'png', '988e7e1504fb32f10505eb95681b1699f0554ca9', '2022-10-09 16:31:09', '2022-10-09 16:31:09', NULL);
COMMIT;
