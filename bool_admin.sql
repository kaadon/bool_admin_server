...
-- ----------------------------
BEGIN;
INSERT INTO `qu_system_admin` (`id`, `username`, `phone`, `password`, `head_image`, `email`, `status`, `group_ids`, `nickname`, `admin_id`, `create_time`, `update_time`) VALUES (1, 'admin', '13572008888', 'e10adc3949ba59abbe56e057f20f883e', 'https://static.boolcdn.net/git/logo/boolcdn/logo.png', 'usdtcloud@gmail.com', 1, '1,4', 'admin', 0, NULL, 1701401908);
COMMIT;
...
INSERT INTO `qu_system_config` (`id`, `name`, `title`, `group`, `sign`, `type`, `value`, `remark`, `weigh`, `create_time`, `update_time`) VALUES (3, 'site_copyright', '版权信息', 'site', 'copyright', 'input', 'CodeMiracles', '网站的版权', 0, NULL, NULL);
...
CREATE TABLE `qu_system_group_admin` (
  ...
  `update_time` int(11) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=utf8 COMMENT='用户-组关系表';

-- ----------------------------
-- Records of qu_system_group_admin
-- ----------------------------
BEGIN;
INSERT INTO `qu_system_group_admin` (`id`, `group_id`, `admin_id`, `create_time`, `update_time`) VALUES (29, 1, 1, 1701401908, 1701401908);
COMMIT;
...
CREATE TABLE `qu_system_log` (
  ...
  `update_time` int(11) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=519 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='后台操作日志表';
...
CREATE TABLE `qu_system_menu` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `pid` (`pid`)
) ENGINE=InnoDB AUTO_INCREMENT=184 DEFAULT CHARSET=utf8 COMMENT='菜单节点表';
...
INSERT INTO `qu_system_menu` (`id`, `type`, `pid`, `title`, `icon`, `path`, `component`, `weigh`, `status`, `permission`, `tag_type`, `tag_value`, `create_time`, `update_time`) VALUES (183, 3, 71, '配置', '', '', NULL, 0, 1, '/admin/plugins/config', NULL, NULL, NULL, NULL);
COMMIT;
